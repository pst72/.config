...
local mappings = {
  ...
  F = { ":Format<cr>", "Format File" },
	...
	l = {
		name = "LSP",
		i = { ":NullLsInfo<cr>", "Connected Language Servers" },
	...
	G = {
		...
		s = { ":Telescope git_status<cr>", "List Git Status" },
		l = { ":Telescope git_files<cr>", "List Git Files" },
		c = { ":Telescope git_bcommits<cr>", "List Buffer Commits" },
		C = { ":Telescope git_commits<cr>", "List Directory Commits" },
