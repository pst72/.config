...
local on_attach = function(_, bufnr)
	...
	nmap("<leader>lw", vim.lsp.buf.add_workspace_folder, "[l]sp [w]orkspace Add Folder")
	nmap("<leader>lW", vim.lsp.buf.remove_workspace_folder, "[l]sp [W]orkspace Remove Folder")
