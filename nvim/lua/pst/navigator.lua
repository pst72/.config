...
local nav_status_ok, nav = pcall(require, "navigator")
if not nav_status_ok then
	print("Problem with NAVIGATOR-CONFIG")
end
lsp_sig.on_attach({
	bind = true,
	handler_opts = {
...
nav.setup({
	...
	transparency = 10, -- 0 ~ 100 blur the main window, 100: fully transparent, 0: opaque,  set to nil or 100 to disable it
